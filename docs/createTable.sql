...
CREATE TABLE CHN_AGC_READ_STATUS
(
    CHN_ID           BIGINT    NOT NULL COMMENT '채널 ID (FK)',
    AGC_ID           BIGINT    NOT NULL DEFAULT 0 COMMENT '대리점 ID (FK, 0이면 본사)',
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_unicode_ci COMMENT '채널별 대리점 읽음 상태';
CREATE INDEX idx_chn_agc_read_status_chn ON CHN_AGC_READ_STATUS (CHN_ID);
